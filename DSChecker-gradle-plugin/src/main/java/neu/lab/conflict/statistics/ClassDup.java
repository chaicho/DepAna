...
public class ClassDup {
    ...
    public boolean equals(Object obj) {
        ...
        ClassDup other = (ClassDup) obj;
        return this.clsSig.equals(other.clsSig);
    }
    ...
    public boolean isAllTestScope() {
        Iterator<DepJar> ite = depJars.iterator();
        while (ite.hasNext()) {
            DepJar depJar = ite.next();
            if ("test".equals(depJar.getScope())){
                ite.remove();
            }
        }
        if (depJars.size()<=1){
