...
//        writer.println(component.getSelectionReason().getDescriptions());
        ...
        if (seen.add(component)) {
            ...
            for (DependencyResult dependency : component.getDependencies()) {
                ...
                if (dependency instanceof ResolvedDependencyResult) {
                    ...
                    for(ComponentSelectionDescriptor descriptor : resolvedDependency.getSelected().getSelectionReason().getDescriptions()){
                        writer.print(descriptor.getCause());
                        writer.print(" ");
                    }
                    writer.println(resolvedDependency.getSelected().getSelectionReason().getDescriptions());
