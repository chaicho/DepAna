    ...
    public void report() throws IOException {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(outputFile))) {
            ...
            for (int i = 0; i < ids.size(); i++) {
                ...
                writer.print("FILE ");
                writer.println(file.getAsFile().getCanonicalPath());
                writer.print("  id: ");
                ...
                writer.println(variant.getAttributes());
                writer.println(variant.getOwner().getDisplayName());
                writer.println(variant.getCapabilities());
                writer.print("  size: ");
